import { User, Cpu, Calendar, Ruler, Weight, AlertCircle, Stethoscope, Edit2, Save, X, Phone, Droplet, Pill, Cloud, Settings, Languages, ChevronRight, Plus, Trash2, Check, Nfc, Wifi, Signal, Bluetooth } from 'lucide-react';
    ...
    <>
      <div className="flex flex-col min-h-screen pb-16">
        <div className="px-4 pt-2 pb-4 space-y-3">
          {/* Profilkopf */}          <div className="bg-white rounded-xl p-3 shadow-sm">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Settings size={16} strokeWidth={2} className="text-[#2F80ED]" />
                <h2 className="text-[12px] font-medium text-[#1F2937]">
                  Einstellungen
                </h2>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Nfc size={16} strokeWidth={2} className="text-[#2F80ED]" />
                <h2 className="text-[12px] font-medium text-[#1F2937]">
                  NFC
                </h2>
              </div>
      ...
      <EmergencyContactModal
        ...
        onUpdateContacts={setEmergencyContacts}
      />
      <SettingsModal
        isOpen={showSettings}
